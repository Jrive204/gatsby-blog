...
@font-face{
	...
	src: local('Muli Black'),local('Black'),
...
body {
	...
	font-family: "Muli Regular", Arial, Helvetica, sans-serif, Arial, Helvetica, sans-serif, sans-serif;
	margin: 0;
...
h1,h2,h3,h4,h5,h6 {
	...
	font-family: 'Muli Black', Arial, Helvetica, sans-serif, Arial, Helvetica, sans-serif, sans-serif;
	transition: all 0.5s ease;
	letter-spacing: 1px;
}
